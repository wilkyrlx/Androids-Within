...
class chainOfCommand implements IGameRules {
    ...
    assignRoles() {
        ...
        this.assignments[this.players[3]] = "You are the Lead Human. Only you can call out the Alpha Android. The following player is a Human directly below you: " + this.players[4];
